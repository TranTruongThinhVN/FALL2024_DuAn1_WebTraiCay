        ...
        <div class="product">
          <div class="product__image-section">
            <div class="product__main-image">
              <img id="mainImage" src="public/assets/client/images/home/dua_luoi_hoang_kim.webp"
                alt="Main Product Image">
            </div>
            <div class="product__thumbnails">
              <img class="product__thumbnail" src="<?= APP_URL ?>public/assets/client/images/product/chomchom_giong_thai.webp" alt="Thumbnail 1"
                onclick="changeImage(this)">
              <img class="product__thumbnail" src="<?= APP_URL ?>public/assets/client/images/product/chomchom_giong_thai.webp" alt="Thumbnail 2"
                onclick="changeImage(this)">
              <img class="product__thumbnail" src="<?= APP_URL ?>public/assets/client/images/product/chomchom_giong_thai.webp" alt="Thumbnail 3"
                onclick="changeImage(this)">
              <img class="product__thumbnail" src="<?= APP_URL ?>public/assets/client/images/product/chomchom_giong_thai.webp" alt="Thumbnail 4"
                onclick="changeImage(this)">
            </div>
            ...
            <div class="review-list">
              <?php foreach ($data as $item): ?>
                <div class="review-item">
                  ...
                  <p class="review-content"><?= htmlspecialchars($item['content']) ?></p>
