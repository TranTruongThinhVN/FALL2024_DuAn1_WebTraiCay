            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <?php if (!empty($data)):?>
                        <div class="col-md-12">
                            <div class="card">
                                <form class="form-horizontal" action="/comments/update" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9 d-flex align-items-center" style="gap: 14px;">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="status" id="status1" value="1" <?= ($data['status'] == 1 ? 'checked' : '') ?>>
                                                    <label class="form-check-label" for="status1">Hiển thị</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="status" id="status0" value="0" <?= ($data['status'] == 0 ? 'checked' : '') ?>>
