                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="bg-dark p-10 text-white text-center">
                                                        ...
                                                        <h5 class="mb-0 mt-1"><?= $data['users']['total_users'] ?></h5>
                                                ...
                                                <div class="col-6">
                                                    <div class="bg-dark p-10 text-white text-center">
                                                        ...
                                                        <h5 class="mb-0 mt-1"><?= $data['user_new']['id'] ?></h5>
                                                ...
                                                <div class="col-6 mt-3">
                                                    <div class="bg-dark p-10 text-white text-center">
                                                        ...
                                                        <small class="font-light">Đơn đặt hàng</small>
                                                    </div>
                                                </div>
                                                <div class="col-6 mt-3">
                                                    <div class="bg-dark p-10 text-white text-center">
                                                ...
                                                <div class="col-6 mt-3">
                                                    <div class="bg-dark p-10 text-white text-center">
                                                        ...
                                                        <small class="font-light">Doanh thu tuần</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
